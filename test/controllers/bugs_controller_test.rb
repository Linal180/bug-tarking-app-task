...
class BugsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create bug" do
    assert_difference('Bug.count') do
      post bugs_url, params: { bug: { name: @bug.name, picture: @bug.picture, string: @bug.string, user_id: @bug.user_id } }
    end
  ...
  test "should update bug" do
    patch bug_url(@bug), params: { bug: { name: @bug.name, picture: @bug.picture, string: @bug.string, user_id: @bug.user_id } }
